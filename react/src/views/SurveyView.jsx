            ...
            <div className='shadow sm:overflow-hidden sm:rounded-md'>
                <div className='space-y-6 bg-white px-4 py-5 sm:p-6'>
                    ...
                    <div className='col-span-6 sm:col-span-3'>
                        ...
                        <textarea name="description" id="description" value={survey.description} placeholder='Describe your survey' className='mt-1 block w-full rounded-md border-gray-300 shadow-s docus:border-indigo-50 focus:ring-indigo-500 sm:text-sm' cols="30" rows="10"
                        onChange={(ev) => setSurvey({ ...survey, description: ev.target.value })} ></textarea>
                    </div>
